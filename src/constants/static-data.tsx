...
export const STATIC_DATA = {
  ...
  navListItems: [
    {
      icon: <IconImg src={GrayPromoOfferPng} alt="nav-item-img" />,
      selectedIcon: <IconImg src={GreenPromoOfferPng} alt="nav-item-img" />,
      name: 'Promotional Offers',
      idx: 0,
    },
    {
      icon: <IconImg src={GrayAbleOfferPng} alt="nav-item-img" />,
      selectedIcon: <IconImg src={GreenAbleOfferPng} alt="nav-item-img" />,
      name: 'Available Offers',
      hasBadge: true,
      idx: 1,
    },
    {
      icon: <IconImg src={GrayMyOfferPng} alt="nav-item-img" />,
      selectedIcon: <IconImg src={GreenMyOfferPng} alt="nav-item-img" />,
      name: 'My Offers',
      idx: 2,
    },
    {
      icon: <IconImg src={GrayWithdrawPng} alt="nav-item-img" />,
      selectedIcon: <IconImg src={GreenWithdrawPng} alt="nav-item-img" />,
      name: 'Withdraw',
      idx: 3,
    },
    {
      icon: <IconImg src={GrayLeaderboardPng} alt="nav-item-img" />,
      selectedIcon: <IconImg src={GreenLeaderboardPng} alt="nav-item-img" />,
      name: 'Leaderboard',
      idx: 4,
    },
    {
      icon: <IconImg src={GrayRewardPng} alt="nav-item-img" />,
      selectedIcon: <IconImg src={GreenRewardPng} alt="nav-item-img" />,
      name: 'Rewards',
      idx: 5,
    },
    {
      icon: <IconImg src={GrayAffiliatePng} alt="nav-item-img" />,
      selectedIcon: <IconImg src={GreenAffiliatePng} alt="nav-item-img" />,
      name: 'Affiliates',
      idx: 6,
    },
  ],
